"""
Django settings for FamilyWorks project.
...
SECRET_KEY = 'django-insecure-b2ne4bime*&%qeu&rznn!6fxw5g09e^4h^q_kc#i^(uyxo%m7y'
...
WSGI_APPLICATION = 'FamilyWorks.wsgi.application'
